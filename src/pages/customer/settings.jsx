                        ...
                        <aside className="lg:col-span-1">
                            <div className="bg-white rounded-xl border border-gray-100 p-2">
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-left transition ${activeSection === 'profile'
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-left transition ${activeSection === 'security'
                                            ? 'bg-green-50 text-green-700'
                                            : 'text-gray-600 hover:bg-gray-50'
                                        }`}
                                >
                                ...
                                <button
                                    ...
                                    className={`w-full flex items-center gap-3 px-4 py-3 rounded-lg text-sm font-medium text-left transition ${activeSection === 'notifications'
                                            ? 'bg-green-50 text-green-700'
                                            : 'text-gray-600 hover:bg-gray-50'
                                        }`}
                                >
    ...
    return (
        <div className="flex items-center justify-between gap-5 py-4 border-b border-gray-100 last:border-0">
            ...
            <button
                type="button"
                onClick={onChange}
                className={`relative flex-shrink-0 w-11 h-6 rounded-full transition ${checked
                        ? 'bg-green-600'
                        : 'bg-gray-300'
                    }`}
            ...
            >
                <span
                    className={`absolute top-1 w-4 h-4 rounded-full bg-white transition ${checked
                            ? 'left-6'
                            : 'left-1'
                        }`}
                />
