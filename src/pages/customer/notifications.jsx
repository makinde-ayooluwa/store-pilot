                ...
                <main className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                    ...
                    <div className="bg-white border border-gray-100 rounded-xl p-2 flex gap-2 mb-5">
                        <button
                            ...
                            className={`flex-1 sm:flex-none px-5 py-2.5 rounded-lg text-sm font-medium transition ${filter === 'all'
                        ...
                        <button
                            ...
                            className={`flex-1 sm:flex-none px-5 py-2.5 rounded-lg text-sm font-medium transition ${filter === 'unread'
                                    ? 'bg-green-600 text-white'
                                    : 'text-gray-600 hover:bg-gray-50'
                                }`}
                        >
                                ...
                                (notification, index) => {
                                    ...
                                    return (
                                        <div
                                            ...
                                            className={`relative p-5 sm:p-6 cursor-pointer transition hover:bg-gray-50 ${index !==
                                        ...
                                        >
                                            <div className="flex gap-4">
                                                {/* Icon */}
                                                <div
                                                    className={`flex-shrink-0 w-11 h-11 rounded-full flex items-center justify-center ${notification.type ===
                                                            'promotion'
